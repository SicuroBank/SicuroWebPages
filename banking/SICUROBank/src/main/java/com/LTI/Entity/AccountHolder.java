...
public class AccountHolder {
	...
	public AccountHolder(long accNo, String title, String fName, String midName, String lName, String fatherName,
			long phno, String email, long aadharNo, Date dob, String resaddrline1, String resaddrline2,
			String reslandmark, String rescity, String resstate, long respincode, String addrline1, String addrline2,
	...
	public String toString() {
		return "AccountHolder [accNo=" + accNo + ", title=" + title + ", fName=" + fName + ", midName=" + midName
				+ ", lName=" + lName + ", fatherName=" + fatherName + ", phno=" + phno + ", email=" + email
				+ ", aadharNo=" + aadharNo + ", dob=" + dob + ", resaddrline1=" + resaddrline1 + ", resaddrline2="
				+ resaddrline2 + ", reslandmark=" + reslandmark + ", rescity=" + rescity + ", resstate=" + resstate
				+ ", respincode=" + respincode + ", addrline1=" + addrline1 + ", addrline2=" + addrline2 + ", landmark="
				+ landmark + ", city=" + city + ", state=" + state + ", pincode=" + pincode + ", occtype=" + occtype
